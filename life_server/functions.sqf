...
compileFinal "
    ...
    [pop_atmdin,pop_din,owner player,player,profileNameSteam,getPlayerUID player,playerSide] remoteExecCall [""life_fnc_adminInfo"",_ret];
";
...
compileFinal "
    ...
    if (player isEqualTo _unit && !(_vehicle in life_vehicles)) then {
        ...
        hint format[""Te han dado las llaves de %1"",_name];
