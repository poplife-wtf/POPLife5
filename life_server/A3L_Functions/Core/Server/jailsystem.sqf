...
_query = format["UPDATE players SET jailtime=%1, arrestreason=%2 WHERE pid=%3",_time,_reasonofarrest,_uid];
...
_query = format["UPDATE players SET jailtime=%1 WHERE pid=%2",_minute,_uid];
[_query,1] call DB_fnc_asyncCall;
};
...
_minute = 0;
_reason = "none";
_query = format["UPDATE players SET jailtime=%1, arrestreason=%2 WHERE pid=%3",_minute,_reason,_uid];
[_query,1] call DB_fnc_asyncCall; };