...
_arrTemp = [];
_tiendasArr = ["POP_npc_vendedor","POP_NPC_tiendaderopa","POP_NPC_chino","POP_npc_man1","POP_npc_mujer","POP_NPC_tendero","POP_npc_vendedor"];
_arrObj = [];
{
...
for [{_x=0},{_x<=_count},{_x=_x+10}] do {
    ...
    if (count _queryResult isEqualTo 0) exitWith {};
    {
		...
		_negocios setVariable ["paga",(60 * 15),true];
