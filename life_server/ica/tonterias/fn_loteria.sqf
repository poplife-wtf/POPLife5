...
if (_param isEqualTo "compro") exitWith {
	...
	if (pop_din < 500) exitWith {hint format ["Te faltan %1€, pero la esperanza es lo último que se pierde.", 500 - pop_din]; closeDialog 0; ocupado = nil};
...
if (_param isEqualTo "cobro") exitWith {
	...
	hint "¡Te ha tocado! ¡¡¡Has ganado 75.000 €!!!";
...
if (_param isEqualTo "historia1") exitWith {
	...
	Después escuché a alguien subiendo las escaleras hacia donde yo estaba -Mierda, estoy jodido- pensé, ya no me daba tiempo a escapar por ningún sitio, así que cerré los ojos sin más esperando mi destino...
	";
};
