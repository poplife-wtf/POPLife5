...
_tiendaLVL11 = [ // veh mafiosos
	["--------- Vehículos ----------", 0],
	["Mercedes_Pullman_negra", 55000 * Desc],
	["pop_insurgent_v1", 55000 * Desc],
	["", 0],
	["--------- Suministros del ELN ----------", 0],
	["BOINA_ELN", 10000 * Desc],
	["hlc_rifle_CQBR", 100000 * Desc],
	["acc_flashlight", 200 * Desc],	
	["muzzle_snds_M", 15000 * Desc],
	["bipod_03_F_blk", 15000 * Desc],
	["hlc_30rnd_556x45_EPR", 500 * Desc],
	["", 0],
	["srifle_LRR_F", 125000 * Desc],
	["optic_LRPS", 20000 * Desc],
	["7Rnd_408_Mag", 1000 * Desc],
	["", 0],
	["DemoCharge_Remote_Mag", 25000]
];
...
if (_param isEqualTo "menu") exitWith {
	...
	createDialog "tiendaTerro";
	_ui = uiNameSpace getVariable "tiendaTerro";
...
if (_param isEqualTo "actualiza") exitWith {
	...
	_boton buttonSetAction '
		["compro", cosa, precio] call ica_fnc_tiendaterrorista;
	';
};
