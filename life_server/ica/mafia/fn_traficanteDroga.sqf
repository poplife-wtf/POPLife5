...
if (_param isEqualTo "menu") exitWith {
    ...
    if ({side _x == WEST} count playableUnits != 0) then {
        //fix by gonzalo mejinarco op
        if (({side _x == civilian} count playableUnits)/({side _x == WEST} count playableUnits) > 0) then {_mult = 0.40};
        if (({side _x == civilian} count playableUnits)/({side _x == WEST} count playableUnits) > 5) then {_mult = 0.30};
        if (({side _x == civilian} count playableUnits)/({side _x == WEST} count playableUnits) > 10) then {_mult = 0.10};
    ...
    if (_modo) then {
        ...
        if (_tio == 1) then {
            ...
            _pre1 ctrlSetText format ["%1 €", 450*_mult];
            _pre2 ctrlSetText format ["%1 €", 600*_mult];
            _pre3 ctrlSetText format ["%1 €", 500*_mult];
            _pre4 ctrlSetText format ["%1 €", 545*_mult];
	    ...
	    _pre1 ctrlSetText format ["%1 €",round (40*(-0.0000005*traf1Mar*2.5*traf1Mar*2.5-0.00025*traf1Mar*2.5+1)*_mult)];
	    _pre2 ctrlSetText format ["%1 €",round (60*(-0.0000005*traf1Her*5*traf1Her*5-0.00025*traf1Her*5+1)*_mult)];
	    _pre3 ctrlSetText format ["%1 €",round (50*(-0.0000005*traf1Coc*5*traf1Coc*5-0.00025*traf1Coc*5+1)*_mult)];
	    _pre4 ctrlSetText format ["%1 €",round (40*(-0.0000005*traf1Met*5*traf1Met*5-0.00025*traf1Met*5+1)*_mult)];
	    ...
	    _pre1 ctrlSetText format ["%1 €",round (40*(-0.0000005*traf2Mar*2.5*traf2Mar*2.5-0.00025*traf2Mar*2.5+1)*_mult)];
	    _pre2 ctrlSetText format ["%1 €",round (60*(-0.0000005*traf2Her*5*traf2Her*5-0.00025*traf2Her*5+1)*_mult)];
	    _pre3 ctrlSetText format ["%1 €",round (50*(-0.0000005*traf2Coc*5*traf2Coc*5-0.00025*traf2Coc*5+1)*_mult)];
	    _pre4 ctrlSetText format ["%1 €",round (40*(-0.0000005*traf2Met*5*traf2Met*5-0.00025*traf2Met*5+1)*_mult)];
...
if (_param isEqualTo "compro") exitWith {
	...
	"Traficante de Droga","RH_m9"] call ica_fnc_axeMsg;
	};
