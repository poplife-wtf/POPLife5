...
if (!isNil {_this select 1}) exitWith {camaraInicial cameraEffect ['TERMINATE', 'BACK']; camaraInicial = nil; ppEffectDestroy borrInicial; borrInicial = nil;disableUserInput false;};
