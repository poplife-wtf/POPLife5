...
if (_param == "rellena") exitWith {
	...
	_habilidades = switch (_rama) do {
		...
		case "for": {["Maratón", "Parkour", "Metabolismo efectivo", "Luchador", "Piernas fuertes", "Mula de carga"]};
		...
		case "art": {["Carga media", "Carga pesada", "Chaleco de carga", "Disturbio líquido", "Polvo explosivo", "Parkour líquido", "Tela de arbusto", "Taladro para Robos", "Pistola muy chula"]};
...
if (_param == "informa") exitWith {
	...
	_txt = switch (_habilidad) do {
		...
		case "con2": {"Tienes un 35% de no gastar el kit de reparación. También reparas un 7% más rápido."};
		case "con3": {"Gastas un 50% menos de combustible. "};
		case "con4": {"Tienes un 70% de no gastar el kit de reparación.  También reparas un 14% más rápido."};
		...
		case "for4": {"Eres un buen luchador entrenado por Berto Romero para matar con tus manos, ademas ya sabes utilizar martillos, katanas,picos y todas las armas cuerpo a cuerpo"};
		case "for5": {"Tus piernas son duras como piedras, ya no se rompen"};
		...
		case "art8": {"Puedes fabricar un taladro para realizar robos con tus colegas."};
		case "art9": {"Puedes fabricar una magnum gold y su munición. Sirve para asustar a ladrones."};
		...
		case "inf4": {"Puedes usar el portátil hacker. Tranqui, hay Wi-Fi gratuíto por todo Lakeside."};
