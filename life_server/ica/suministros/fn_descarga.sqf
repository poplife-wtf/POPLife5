...
_formula = {
	...
	_multi=_multi*(-0.00000005*variable*variable-0.000025*variable+1);
	_n = 30;
...
pop_din = pop_din + _valorTotal;
	...
	{ 
	[(round (_valorTotal * 0.10)),_organizacion] call life_fnc_gangExtorsion;  
	};
	

[format ["+ %1€", _valorTotal]] call ica_fnc_infolog;

["exp", _valorTotal / 900] call ica_fnc_arrayExp;
