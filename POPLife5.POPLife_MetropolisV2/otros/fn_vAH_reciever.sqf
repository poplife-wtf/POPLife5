/*
	File: fn_vAH_reciever.sqf //Editado por Rosen
...
switch (_mode) do
{
	case 0:
	{
		...
		hint format["Has comprado articulos a %1 por %2€",_seller,[_price]call life_fnc_numberText];
		closeDialog 0;
	};
	case 1:
	{
		...
		[
			"%1 ha comprado un articulo, ha recibido <br/>
