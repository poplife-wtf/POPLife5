	...
	class controls
		{
			...
			{
				idc = 2505;
				text = "\Heisenberg\fotos\pcdeepweb2.paa";
			...
			class deepwebhwRscActivePicture_2507: RscActivePicture
			{
				idc = 2507;
				...
				onButtonClick = "createdialog 'pcpopdwnocturno';['relleno'] call ica_fnc_portatil";
			...
			class HackRscButtonSilent_3006: RscButtonSilent
			{
				...
				soundClick[] ={"\A3\ui_f\data\sound\RscButton\soundClick",0.09,1};
				soundEscape[] ={"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1};
				onButtonClick = "_nil = ['verifica', ctrlText 2506, (lbData [2058, lbCurSel 2058])] spawn ica_fnc_portatil";
			};
		};
};