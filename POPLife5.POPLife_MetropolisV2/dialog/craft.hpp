...
class CraftRscActivePicture_1002: RscActivePicture
{
	...
	text = "axex\botoncraft.paa"; //--- ToDo: Localize;
...
class Heisenberg: RscText
{
	idc = 1004;
	text = "HW"; //--- ToDo: Localize;
	x = 65.04 * GUI_GRID_W + GUI_GRID_X;
	y = -10.98 * GUI_GRID_H + GUI_GRID_Y;
	w = 4.001 * GUI_GRID_W;
	h = 2.5 * GUI_GRID_H;
};
