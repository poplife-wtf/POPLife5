...
class controls {
		...
		class SendButtonKey : Life_RscButtonMenu {
			idc = 9005;
			text = "Enviar";
			onButtonClick = "_param = if (!isNil {uiNamespace getVariable 'anuncioAnonimo'}) then {['anonimo']} else {[]}; _param call life_fnc_sendChannel; closeDialog 0;";
			// onButtonClick = "[] call life_fnc_sendChannel; closeDialog 0;"; // este es el que había antes
