class tiendaBf
{
	idd = -1;
	movingenable = true;
	onLoad = "uiNamespace setVariable ['tiendaBf', _this select 0];";
	onUnLoad = "uiNamespace setVariable ['tiendaBf', nil]; cosa = nil; precio = nil; ";
	
	class controls {
		class RscPicture_1200: RscPicture
		{
			text = "\pop_iconos\paa\bfondos.paa";
			idc = 5005;
		...
		class RscListbox_1500: RscListbox
		{
			...
			sizeEx = 0.034;
			onLBSelChanged = "['actualiza'] call ica_fnc_tiendaBf";
		};
