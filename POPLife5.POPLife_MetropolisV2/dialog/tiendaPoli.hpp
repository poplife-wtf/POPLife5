class tiendaPoli
{
	idd = -1;
	movingenable = true;
	onLoad = "uiNamespace setVariable ['tiendaPoli', _this select 0];";
	onUnLoad = "uiNamespace setVariable ['tiendaPoli', nil]; cosa = nil; precio = nil; ";
	
	class controls {
		class RscPicture_1200: RscPicture
		{
			text = "\pop_iconos\paa\tiendaPolicia.paa";
			idc = 5005;
		...
		class RscListbox_1500: RscListbox
		{
			...
			sizeEx = 0.034;
			onLBSelChanged = "['actualiza'] call ica_fnc_tiendaPolicia";
		};
		class icaruk: RscText
		{
			idc = -1;
			text = "AxE"; //--- ToDo: Localize;
