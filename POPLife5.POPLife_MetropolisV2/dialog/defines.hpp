...
class TelefonoRscButton
{
	...
	colorShadow[] = {0,0,0,0};
	colorBorder[] = {0,0,0,0};
	soundEnter[] = {"\pop_iconos2\Movil\Sonidos\Android\a_pulsar.ogg",	0.09,1};
	soundPush[] = {"\pop_iconos2\Movil\Sonidos\Android\a_pulsar.ogg",0.09,1};
	soundClick[] = {"\pop_iconos2\Movil\Sonidos\Android\a_pulsar.ogg",0.09,1};
	soundEscape[] = {"\pop_iconos2\Movil\Sonidos\Android\a_pulsar.ogg",0.09,1};
	period = 1.2;
	periodFocus = 1.2;
	periodOver = 1.2;
	access = 0;
...
class CajeroRscButton
{
		deletable = 0;
		fade = 0;
		colorText[] = {0.4,0.4,0.4};
		colorDisabled[] = {0,0,0,0};
		colorBackground[] = {0,0,0,0};
		colorBackgroundDisabled[] = {0,0,0,0};
		colorBackgroundActive[] = {0,0,0,0};
...
class ADAMUZ_RscStructuredText
{
	access = 0;
	type = 13;
	idc = -1;
