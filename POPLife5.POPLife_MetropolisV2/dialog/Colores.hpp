// Alpha Channels
#define Dlg_PoP_Action_bgn 			0.5
#define Dlg_Alpha_bgn 				1
#define Dlg_Alpha_Text 				1
#define Dlg_Alpha_In 				1
#define Dlg_Alpha_InText 			1
#define Dlg_Alpha_Selectable		1
#define Dlg_Alpha_SelectableOver	1
#define Dlg_Alpha_SButton			0.7
#define Dlg_Alpha_SButtonFocus		1
