/*
DEBUG PARA PLATA O PLOMO - Heis
*/
class RscListBox_PoP {
access=0;
type=5;
style=0;
font="PuristaLight";
...
class PoP_LIST1384:RscListBox_PoP{idc=1384;x=-0.25;y=0.2;w=0.25;h=0.9;sizeEx=0.027;};
};
};
...
class PoP_LIST1500:RscListBox_PoP
{
idc=1500;
...
class PoP_LIST1501:RscListBox_PoP
{
idc=1501;
