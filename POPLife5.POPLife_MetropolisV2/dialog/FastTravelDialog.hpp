...
class ETG_FastTravelSystem_Dialog
{
	...
	movingEnable = false;
	moving = 0;
	onLoad = "[2] spawn ica_fnc_ftravel";
	...
	class controls
	{
		class FastTravel_Button: RscButton
		{
			...
			h = 0.022 * safezoneH;
			action = "_destination = lbData [147413,(lbCurSel 147413)];[3,_destination] spawn ica_fnc_ftravel; closeDialog 0;";
		...
		class FastTravel_Listbox: RscListbox
		{
			...
			w = 0.103125 * safezoneW;
			h = 0.22 * safezoneH;
			tooltip = "Seleccione su destino.";
			sizeEx = 0.03;
			onLBSelChanged = "[1] spawn ica_fnc_ftravel";
		};
