...
if (pop_din > 0) then {
    [pop_din,player,_robber] remoteExecCall ["life_fnc_robReceive",_robber];
    ...
    //[1,"STR_NOTF_Robbed",true,[_robber getVariable ["realname",name _robber],profileName,[pop_din] call life_fnc_numberText]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
    pop_din = 0;
