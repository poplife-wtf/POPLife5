...
switch (life_veh_shop select 0) do
{
	...
	case "bus": {_ret = license_civ_busetero;};
	...
	case "taxista_shop": {_ret = license_civ_taxista;};
	case "periodista_shop": {_ret = license_civ_periodista;};
	case "tienda_trasporte": {_ret = license_civ_transportista;};
	...
	case "donator_sport": {_ret = true;};
	case "donator_truck": {_ret = true;};
	case "donator_chopper": {_ret = true;};
	case "donator_gold": {_ret = true;};
