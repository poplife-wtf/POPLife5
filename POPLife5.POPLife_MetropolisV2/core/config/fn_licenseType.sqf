...
switch (_mode) do {
	case 0: {
		switch (_type) do {
			...
			case "bus": {_var = "license_civ_busetero"};	// Licencia de bus
			case "periodista": {_var = "license_civ_periodista"};	// Licencia de Periodista
			case "transporte": {_var = "license_civ_transportista"};	// Licencia de transporte
	...
	case 1: {
		switch (_type) do {
			...
			case "license_civ_busetero": {_var = "bus"};
			case "license_civ_periodista": {_var = "periodista"};
			case "license_civ_transportista": {_var = "transporte"};
