...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Motorcycle") || (_vehicle isKindOf "A3L_Tahoe_Base")) then
{
	...
	{
		if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Motorcycle") ||(_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship"))) exitWith {life_action_inUse = false;};
		...
		switch (true) do
		{
			...
			case (_vehicle isKindOf "Motorcycle"): {if(playerSide == west) then {_price = (call life_impound_car_cop);}else{_price = (call life_impound_car);};};
