...
_this spawn {
	...
	switch (_mode) do {
		...
		case 1: {
			...
			player setPos [7741.87,6419.84,0.00143909];
		};
		case 2: {
			_firstCond = _raceConfig select 2;
			...
			if(_finishTime < (_firstCond select 1)) then {
				hint "Has finalizado correctamente la prueba. Ya tienes el carné de camion.";
			...
			player setPos [7763.58,6456.51,0.00143909];
		};
	};
};