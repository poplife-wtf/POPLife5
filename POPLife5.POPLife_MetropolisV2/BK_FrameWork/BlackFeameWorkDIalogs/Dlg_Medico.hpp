...
class BK_DialogoMedico {
	idd = 30105;
	movingEnable = 0;
	onLoad = "uiNamespace setVariable ['BK_DialogoMedico', _this select 0]; playSound 'FxDialogOpen'; ";
...
class TextTratar: Bk_RscButton
{
	...
	colorBackgroundActive[] = { 1, 1, 1, 0 }; // background color for active state	
	colorText[] = {1, 1, 1, 1};
...
class TextTratarCon: Bk_RscButton
{
	idc = 1001;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
...
class IcoEpenefrina: Bk_RscPicture
{
	...
	w = 0.0309375 * safezoneW;
	h = 0.077 * safezoneH;
	tooltip = "Epinefrina"; //--- ToDo: Localize;
};
...
class TextSamgrados: Bk_RscButton
{
	idc = 1006;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
...
class TextLesiones: Bk_RscButton
{
	idc = 1007;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
...
class TextDiagnostico: Bk_RscButton
{
	idc = 1008;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
...
class TextSelTratar: Bk_RscButton
{
	idc = 1011;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
...
class TextSelTratarCon: Bk_RscButton
{
	idc = 1012;
	colorBackground[] = {0,0,0,0};
	colorFocused[] = { 1, 0, 0, 0 }; // border color for focused state
