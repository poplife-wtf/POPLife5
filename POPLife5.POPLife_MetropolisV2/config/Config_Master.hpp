...
/* System Settings */
    ...
    donor_level = true; //Enable the donor level set in database (var = Life_donator; levels = 0,1,2,3,4,5). ATTENTION! Before enabling, read: https://www.bistudio.com/community/game-content-usage-rules & https://www.bistudio.com/monetization
    ...
    escapeMenu_displayText = "poplife.wtf"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    bank_med = 3500; //Amount of cash in bank for new medics

    paycheck_cop = 600; //Payment for cops
    paycheck_civ = 350; //Payment for civillians
    paycheck_med = 1100; //Payment for medics
